...
if __name__ == '__main__':
    ...
    datapath = r'C:\Users\workshop\CS5242-project\data20'
...
dataset = np.reshape(dataset, (dataset.shape[0], dataset.shape[2], dataset.shape[3], dataset.shape[4], dataset.shape[5]))
print('Dataset shape: ' + str(dataset.shape))
np.save(os.path.join(datapath, 'dataset.npy'), dataset)